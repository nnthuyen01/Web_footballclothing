...
<body>
	...
	<div class="row">
		<div id="sidebar" class="span3">
			...
			<div class="well well-small">
				<a href="#"><img src="/WebAoBD/assets/user/img/paypal.jpg"
			...
			<ul class="nav nav-list promowrapper">
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							...
							VIEW</a> <img src="/WebAoBD/assets/user/img/Mu.jpg" alt="MU sân nhà">
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
									class="pull-right">150.000 ₫</span>
							</h4>
						</div>
					</div>
				</li>
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="/WebAoBD/assets/user/img/Mc-khach.jpg"
							alt="MC sân khách">
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
				...
				<li>
					<div class="thumbnail">
						<a class="zoomTool" href="product_details.html"
							title="add to cart"><span class="icon-search"></span> QUICK
							VIEW</a> <img src="/WebAoBD/assets/user/img/real-khach.jpg"
							alt="Áo bán chạy">
						<div class="caption">
							<h4>
								<a class="defaultBtn" href="product_details.html">VIEW</a> <span
...
-->
		<div class="well well-small">
			...
			<div class="row-fluid">
				<div id="newProductCar" class="carousel slide">
					<div class="carousel-inner">
						<c:if test="${ lastProduct.size() > 0 }">
							<div class="item active">
								<ul class="thumbnails">
									<c:forEach var="item" items="${ lastProduct }" varStatus="loop">
										<li class="span3">
											<div class="thumbnail">
												<a class="zoomTool" href="product_details.html"
													title="add to cart"><span class="icon-search"></span>
													QUICK VIEW</a> <a href="product_details.html"><img
													src="<c:url value="${ item.img }"/>" alt=""></a>
											</div>
										</li>
										<c:if
											test="${ (loop.index + 1) % 4 == 0 || (loop.index + 1)  == lastProduct.size() }">
								</ul>
							</div>
							<c:if test="${ (loop.index + 1) < lastProduct.size() }">
								<div class="item">
									<ul class="thumbnails">
							</c:if>
						</c:if>
	...
	-->
		...
		<hr>
		<div class="well well-small">
			<a class="btn btn-mini pull-right" href='<c:url value="/san-pham"/>'>Xem thêm <span
