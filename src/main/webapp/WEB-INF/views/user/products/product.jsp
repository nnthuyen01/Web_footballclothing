...
<div class="well well-small">
	<ul class="nav nav-list">
		<li><a href="products.html"><span class="icon-chevron-right"></span>Premier League</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Bundesliga</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Serie A</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>La Liga</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Ligue 1</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>Eredivisie</a></li>
		...
		<li> <a class="totalInCart" href="cart.html"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;"></span></strong></a></li>
			  ...
			  <div class="well well-small" ><a href="#"><img src="/WebAoBD/assets/user/img/paypal.jpg" alt="payment method paypal"></a></div>
			...
			<li>
			  <div class="thumbnail">
				...
				<img src="/WebAoBD/assets/user/img/Mu.jpg" alt="bootstrap ecommerce templates">
				<div class="caption">
				  <h4><a class="defaultBtn" href="product_details.html">VIEW</a> <span class="pull-right">150.000 ₫</span></h4>
				</div>
			  </div>
			</li>
			<li style="border:0"> &nbsp;</li>
			<li>
			  <div class="thumbnail">
				<a class="zoomTool" href="product_details.html" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<img src="/WebAoBD/assets/user/img/Mc-khach.jpg" alt="shopping cart template">
				<div class="caption">
				  <h4><a class="defaultBtn" href="product_details.html">VIEW</a> <span class="pull-right">150.000 ₫</span></h4>
				</div>
			  </div>
			...
			<li>
			  <div class="thumbnail">
				<a class="zoomTool" href="product_details.html" title="add to cart"><span class="icon-search"></span> QUICK VIEW</a>
				<img src="/WebAoBD/assets/user/img/real-khach.jpg" alt="bootstrap template">
				<div class="caption">
				  <h4><a class="defaultBtn" href="product_details.html">VIEW</a> <span class="pull-right">150.000 ₫</span></h4>
				</div>
			  </div>
